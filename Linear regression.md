...
## Formulation
Given a data set $\{ y_i, x_{i1}, \dots, x_{ip} \}^n_{i = 1}$ of $n$ [[Statistical units]], a linear regression model assumes that the relationship between the dependent variable $y$ and the vector of regressors $\mathbf{x}$